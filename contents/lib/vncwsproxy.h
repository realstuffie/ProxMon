...
// which keeps them out of the QML/JS heap. The Secure suffix describes that handoff, not
// erasure: see the credential security model in docs/ARCHITECTURE.md for what is and is
// not guaranteed.
